...
//
// PURPOSE:
//  The following example shows how to get the absolute travel value of a Ccpm Servo
//  Tester the the PWM signal. It is expecting to have the signal pin of the Ccpm
//  Servo Tester connected to PIN 2 of the arduino.
//  See https://www.google.ca/search?q=ccpm+servo+tester&espv=2&biw=1920&bih=979&source=lnms&tbm=isch&sa=X
//
...
void loop() {
  ...
  if (receiver_aux1_handler.hasChanged())
  {
    ...
    RcReceiverSignal::VALUE value = receiver_aux1_handler.getDeviceSignalValue(CCPM_SERVO_TESTER, pwmValue);
